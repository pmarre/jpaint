...
public class CreateEllipseCommand implements ICommand, IUndoable, IShape {
    public ShapeInfo si;
    public PaintCanvasBase pc;
    public Point start;
    public Point end;

    public CreateEllipseCommand(ShapeInfo si) {
        this.si = si;
        this.pc = si.pc;
        this.start = si.start;
        this.end = si.end;
    ...
    public void execute() {
        ...
        IShape el = new DrawEllipseStrategy(si.state, pc, x, y, width, height);

        el.draw(pc.getGraphics2D());
